  ...
  proxy: {
    ...
    quickSetup: {
      ...
      fields: {
        ...
        shortId: 'Short ID',
        fingerprint: 'Fingerprint',
        domain: 'Domain (for TLS certificate, optional)',
        domainRequired: 'Optional. Leave blank → self-signed cert + `insecure=1` auto-injected into the subscription URL (clients must skip cert verification). Provide a domain pointed at this server → Let\'s Encrypt cert with strict TLS verification.',
